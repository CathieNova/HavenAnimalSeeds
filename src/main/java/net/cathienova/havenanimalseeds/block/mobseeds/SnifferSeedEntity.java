...
public class SnifferSeedEntity extends MobSeedEntity<Sniffer> {
    public SnifferSeedEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.sniffer_seed_tile.get(), pos, state, CommonConfig.snifferSeedSpawnTimer.get(), EntityType.SNIFFER, CommonConfig.snifferSeedSpawnTimer.get());
    }
}
